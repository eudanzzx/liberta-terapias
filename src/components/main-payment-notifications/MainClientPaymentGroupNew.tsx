...
import { CheckCircle, Trash2, ChevronDown, ChevronRight, Eye } from "lucide-react";
import { MainPaymentCardNew } from "./MainPaymentCardNew";
import { GroupedPayment } from "@/components/tarot/payment-notifications/utils/paymentGrouping";

interface MainClientPaymentGroupNewProps {
...
export const MainClientPaymentGroupNew: React.FC<MainClientPaymentGroupNewProps> = ({
  group,
  onMarkAsPaid,
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <div className="space-y-2">
        ...
        <MainPaymentCardNew payment={group.mostUrgent} />
